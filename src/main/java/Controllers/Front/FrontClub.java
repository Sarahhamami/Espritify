...
public class FrontClub implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for (Club club : o) {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Front/FrontClubItem.fxml"));
            HBox item = null;
            Node node = null;
    ...
    private void displayEvents(List<Evenement> events) {
        ...
        for (Evenement event : events) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Front/FrontEventsItem.fxml"));
            HBox item = null;
            try {
                item = loader.load();
            } catch (IOException e) {
            ...
            FrontItemEventsController controller = loader.getController();
    ...
    void VoirCalendrier(ActionEvent event) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Front/calendar.fxml"));
        Parent root = null;
        try {
            root = loader.load();
        } catch (IOException e) {
