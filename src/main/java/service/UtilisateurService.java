...
public class UtilisateurService implements Iservice<Utilisateur> {
    ...
    public void add(Utilisateur utilisateur) {
        ...
        String requete = "INSERT INTO utilisateur (nom, prenom, email, mdp, tel, niveau, role, image) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            preparedStatement.setInt(5, utilisateur.getTel());
            preparedStatement.setString(6, utilisateur.getNiveau());
